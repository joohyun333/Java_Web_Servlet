...
<body>
	<form name="buylist" enctype="multipart/form-data" method="post">
		...
		<div class="topnav">
			...
			<a href="../GoodsManage/goodslist">물품
				관리</a>
		...
		<div id="wrap">
			...
			<table>
				...
				<c:forEach items="${buyList}" var="list">
					...
					<tr>
						<td style="cursor: pointer;" onclick="location.href='../CustomersManage/buyRead?cusName=${list.cusName}'">${list.cusName}</td>
