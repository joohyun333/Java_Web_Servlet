...
<form name="inputlist" action="tradelist" enctype="multipart/form-data" method="post">
	...
	<div id="wrap">
		...
		<span style="float: right;">
			<button type="button" id="plus" onclick="location.href='../GoodsManage/goodslist'">거래 추가</button>
		</span>
		</br>
		...
		<table>
			...
			<c:forEach items="${TradeList}" var="tradeList">
				<tr>
					...
					<th><input type="button" id="delete" name="delete" onclick="location.href='../TradeGoodsManage/tradeGoodsDelete?dealNumber=${tradeList.dealNumber}'" value="삭제"></input></th>
				</tr>
			</c:forEach>
		</table>
	</div>
