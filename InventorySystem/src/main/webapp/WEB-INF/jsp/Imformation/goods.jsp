...
<body>
   ...
   <h1>물품조회</h1>
   <input type="button" id="deal" name="deal" onclick="location.href='/InventorySystem/Imformation/deal'" value="거래내역조회"></input>
   <input type="button" id="sale" name="sale" onclick="location.href='/InventorySystem/Imformation/sale'" value="판매조회"></input>
<table>
   <tr>
     <th>물품번호</th>
     <th>물품명</th>
